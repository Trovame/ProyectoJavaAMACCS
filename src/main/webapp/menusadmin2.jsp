...
<div class="container">
    ...
    <form action="ControllerSearch" method="get">
        ...
        <div class="mb-3 row">
            <div class="offset-sm-4 col-sm-8">
                <button type="submit" class="btn btn-primary" name="boton" value="FiltrarAdmin">Buscar</button>
            </div>
        </div>
    </form>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <% 
                // Obtener lista de productos desde el atributo 'consulta'
                List<Producto> productos = (List<Producto>) request.getAttribute("listaPlatillos");
