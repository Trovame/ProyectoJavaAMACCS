...
<body>
    <div class="container">
        ...
        <form method="post" action="ControllerEmpleado" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="id" class="col-4 col-form-label">ID Empleado</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="id" id="id" value="<%= request.getParameter("idEmpleado") %>" readonly>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nombres" class="col-4 col-form-label">Nombres Empleado</label>
                <div class="col-8">
