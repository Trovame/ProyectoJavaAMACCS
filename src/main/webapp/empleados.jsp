...
<%@ page import="ModelosDAO.EmpleadoDAO"%>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container">
                ...
                <br>
                <form method="post" action="ControllerEmpleado" enctype="multipart/form-data">
                    <div class="mb-3 row">
                        <label for="inputName" class="col-4 col-form-label">Nombres Empleado</label>
                        <div class="col-8">
                            <input type="text" class="form-control" name="nombres" id="nombres" placeholder="Ingrese el nombre del empleado" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputName" class="col-4 col-form-label">Apellidos</label>
                        <div class="col-8">
                            <input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Ingrese los apellidos del empleado" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputName" class="col-4 col-form-label">Correo</label>
                        <div class="col-8">
                            <input type="text" class="form-control" name="correo" id="correo" placeholder="Ingrese el correo del empleado" required  oninput="validarCorreo(this)">
                        </div>
                    </div>
                    ...
                    <script>
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Ingrese el usuario del empleado" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputName" class="col-4 col-form-label">Contraseña</label>
                        <div class="col-8">
                            <input type="password" class="form-control" name="password" id="password" placeholder="Ingrese la contraseña del empleado" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
            ...
            <div class="container">
                ...
                <div class="container">
                   <label for="cantidadRegistros">Mostrar registros por página:</label>
                    ...
                    <%
                        ...
                        List<Empleado> listaEmpleados = empleadoDAO.listEmpleados();
                    ...
                    <tr>
                        ...
                        <td class="password-field"><%=empleado.getPassword()%></td>
                        <td><img src="img/<%=empleado.getImagen()%>" class="imagen-pequena" alt="Imagen Empleado"></td>
                        <td>
                            <a class="btn btn-warning" href="editar4.jsp?idEmpleado=<%=empleado.getIdEmpleado()%>&nombres=<%=empleado.getNombres()%>&apellidos=<%=empleado.getApellidos()%>&correo=<%=empleado.getCorreo()%>&usuario=<%=empleado.getUsuario()%>&password=<%=empleado.getPassword()%>&imagen=<%=empleado.getImagen()%>">Editar <i class="bi bi-pencil-square"></i></a>
                            <a href="javascript:void(0);" class="btn btn-danger" onclick="showConfirmation(<%= empleado.getIdEmpleado()%>)">Eliminar  <i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                    <% }%>
                </table>
                ...
                <c:set var="totalEmpleados" value="${empleados.size()}" />
                <script>
                    var pagina = 1; // Página actual
                    var totalEmpleados = ${totalEmpleados}; // Asegúrate de que totalJefes esté disponible en el ámbito de la página
                    var registrosPorPagina = parseInt(document.getElementById("cantidadRegistros").value);
                    var totalPaginas = Math.ceil(totalEmpleados / registrosPorPagina);
                    ...
                    function mostrarRegistros() {
                        ...
                        totalPaginas = Math.ceil(totalEmpleados / registrosPorPagina);
        ...
        <div class="confirmation-modal" id="confirmationModal">
            <div class="confirmation-box">
                <p class="confirmation-message">¿Desea eliminar el Empleado?</p>
                        ...
                        function showConfirmation(id) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    window.location.href = 'ControllerEmpleado?idEmpleado=' + id;
                                }
                            });
                        }
