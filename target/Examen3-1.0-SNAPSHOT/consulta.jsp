    ...
    <div>
        ...
        <div class="container">
            ...
            <form action="ControllerBusca" method="get" style="max-width: 400px; margin: auto;">
                ...
                <button type="submit" class="btn btn-success" name="boton" value="buscarPorAparte">  <i class="bi bi-search"></i></button> 
                               <a href="ControllerReservacion" class="btn btn-success">Todas las Reservaciones</a>
           </form>
        </div>
