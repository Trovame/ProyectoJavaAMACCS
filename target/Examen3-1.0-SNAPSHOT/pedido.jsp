        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="container">
                    ...
                    <%
                        try {
                            List<Pedido> listaPedidos = new PedidoDAO().listPedidos();
                 ...
                 <br>
                    ...
                    <c:set var="Pedido" value="${consulta.size()}" />
                    <script>
                        var pagina = 1; // Página actual
                        var Pedido = ${Pedido}; // Asegúrate de que totalJefes esté disponible en el ámbito de la página
                        var registrosPorPagina = parseInt(document.getElementById("cantidadRegistros").value);
                        var totalPaginas = Math.ceil(Pedido / registrosPorPagina);
                        ...
                        function mostrarRegistros() {
                            ...
                            totalPaginas = Math.ceil(Pedido / registrosPorPagina);
