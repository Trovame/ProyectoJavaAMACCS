...
<html>
    <head>
        ...
        <% if (request.getSession().getAttribute("pedidoRealizado") != null) {%>
        <script>
            var mensaje = "<%= request.getSession().getAttribute("pedidoRealizado")%>";
            alert(mensaje);
        </script>
        <%
                // Limpiar el atributo de sesión después de mostrar el mensaje
                request.getSession().removeAttribute("pedidoRealizado");
            } %>
        <style>
            /* Estilos generales */
            body {
        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="container">
                            ...
                            <form action="ControllerPedido" method="post" onsubmit="enviarYEliminar()">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha" name="fecha" value="<%= session.getAttribute("fecha") != null ? session.getAttribute("fecha") : ""%>" <% if (session.getAttribute("fecha") != null) { %>readonly<% } %> required>
                                </div>
                                <div class="form-group">
                                    <label for="estado">Estado</label>
                                    <input type="text" class="form-control" id="estado" name="estado" value="Ordenado" readonly required>
                                </div>
                                <button type="submit" name="eliminar" class="btn btn-primary" value="PedidoMesero">Realizar Pedido</button>
                    ...
                    <!-- Agrega tu código de JavaScript personalizado aquí -->
